...
const hrefs = ['index.html', 'about.html', 'contact.html']; // URLs for each option
        ...
        switch (gameTitle.toLowerCase()) {
            ...
            case '18 wheeler: american pro trucker':
                ...
                case '21: two one':
                    ...
                    break;
                case '90 minutes: sega championship football':
                    dreamcastGames.push('90-minutes-sega-championship-football.html');
                    break;
                case "disney's 102 dalmatians: puppies to the rescue":
                    dreamcastGames.push('disneys-102-dalmatians-puppies-to-the-rescue.html');
                    break;
                case 'advanced daisenryaku 2001 ':
                    dreamcastGames.push('advanced-daisenryaku-2001.html');
                    break;
                case 'advanced daisenryaku: europe no arash':
                    dreamcastGames.push('advanced-daisenryaku-europe-no-arash.html');
                    break;
                case 'aero dancing':
                    dreamcastGames.push('aero-dancing.html');
                    break;
                case 'aerowings':
                    dreamcastGames.push('Aero-wings.html');
                    break;
                case 'aerowings 2: airstrike':
                    dreamcastGames.push('aero-wings-2-airstrike.html');
                    break;
                case 'after...':
                    dreamcastGames.push('after.html');
                    break;
                case 'gauntlet legends':

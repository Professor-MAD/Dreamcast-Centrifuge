...
const options = ['Your Custom List', 'Home', 'About']; // Changed 'custom-games.html' to 'Your Custom List'
let hrefs;
if (window.innerWidth <= 768) {
    // Mobile screen size
    hrefs = ['custom-games-mobile.html', 'index.html', 'about.html'];
} else {
    hrefs = ['custom-games.html', 'index.html', 'about.html'];
}
...
form.addEventListener('submit', function(event) {
    ...
    if (isFormSubmittedSuccessfully) {
        message.textContent = "Success! Party like it's 1999!";
